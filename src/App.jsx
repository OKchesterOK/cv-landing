      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <section className="md:col-span-2 space-y-10">
          ...
          <Section title="ОСВІТА">
            <ListItem title="Магістр" subtitle="Кіровоградська Льотна Академія Національного Авіаційного Університету, м. Кропивницький (вер 2013 — чер 2014)" bullets={[
              'Спеціальність: Льотна експлуатація повітряних суден',
              'Професійна кваліфікація: Пілот (літака)'
            ]} />
            <ListItem title="Бакалавр з аеронавігації" subtitle="Кіровоградська Льотна Академія Національного Авіаційного Університету, м. Кропивницький (вер 2010 — чер 2013)" bullets={[
              'Спеціальність: Аеронавігація'
            ]} />
            <ListItem title="Бакалавр з електроніки" subtitle="Національний авіаційний університет, м. Київ (вер 2006 — чер 2010) (без диплому)" bullets={[
              'Спеціальність: Обладнання повітряних суден'
            ]} />
